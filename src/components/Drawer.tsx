    ...
    <>
      <div className="drawer">
        ...
        <div className="drawer-side">
          ...
          ></label>
          <div className="menu p-4 w-80 min-h-full bg-neutral-700 text-neutral-200">
            {/* Sidebar content here */}
            <p className="p-4 font-bold">{getLanguage0}</p>
            <select
              className="select select-bordered w-full max-w-xs bg-neutral-800 text-neutral-300"
              id="selectLanguage"
